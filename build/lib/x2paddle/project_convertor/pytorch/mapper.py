...
NN_MAPPER = {
    ...
    #my
    "torch.nn.functional.unfold": ["paddle.nn.functional.unfold", FuncUnfold],
    "torch.nn.functional.elu": ["paddle.nn.functional.elu", None],
...
API_MAPPER = {
    ...
    "torch.randint": ["paddle.randint", FuncRandint],
    "torch.where": ["paddle.where", None],
    "torch.softmax": ["paddle.nn.functional.softmax", SoftmaxFuncMapper],
    "torch.cos": ["paddle.cos", OneMathMapper],
    "torch.sin": ["paddle.sin", OneMathMapper],
    "torch.chunk": ["paddle.chunk", FuncChunk],
  
}

# [torch.randint, torch.where]
# [torch.empty, torch.softmax]
# [torch.cos, torch.sin]
# [torch.nn.functional.elu]
# [torch.chunk, torch.empty, torch.nn.functional.unfold]

# [torch.nn.ConvTranspose3d, torch.autograd.function.Function, torch.nn.functional.upsample]
# [torch.nn.ConvTranspose3d, torch.autograd.function.Function, torch.nn.functional.upsample]
# [torch.nn.functional.l1_loss]
# [torch.autograd.function.Function, torch.softmax, torch.gather, torch.norm, torch.meshgrid, torch.nn.functional.grid_sample, torch.nn.Unfold, torch.nn.ConvTranspose3d, torch.flip]

print("============================API_MAPPER:",len(API_MAPPER))
